...
function corrections_civicrm_install() {
  _corrections_civix_civicrm_install();
}
...
function corrections_civicrm_uninstall() {
  _corrections_civix_civicrm_uninstall();
}
...
function corrections_civicrm_enable() {
  _corrections_civix_civicrm_enable();
}
...
function corrections_civicrm_disable() {
  _corrections_civix_civicrm_disable();
}
...
function corrections_civicrm_managed(&$entities) {
  _corrections_civix_civicrm_managed($entities);
}
 ...
 * @link http://wiki.civicrm.org/confluence/display/CRMDOC/hook_civicrm_caseTypes
 */
function corrections_civicrm_angularModules(&$angularModules) {
_corrections_civix_civicrm_angularModules($angularModules);
}
 ...
 *
function corrections_civicrm_preProcess($formName, &$form) {
